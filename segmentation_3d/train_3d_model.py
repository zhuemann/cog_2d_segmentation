...
def train_3d_image_text_segmentation(config, batch_size=8, epoch=1, dir_base = "/home/zmh001/r-fcb-isilon/research/Bradshaw/", n_classes = 2):
    ...
    LR = 0.00005 #1e-5 #5e-5 #30e-5  #1e-4 #5e-5 #5e-5 was lr for contextualnet runs #8e-5  # 1e-4 was for efficient #1e-06 #2e-6 1e-6 for transformer 1e-4 for efficientnet
    #LR = 5e-4
    N_EPOCHS = epoch
    N_CLASS = n_classes
    #LR = 1e-4
