    ...
    for epoch in range(1, N_EPOCHS + 1):
        ...
        with torch.no_grad():
            ...
            for _, data in tqdm(enumerate(valid_loader, 0)):
                ...
                max_targets, max_outputs = get_max_pixel_value_3d(images, targets_detached.cpu().numpy(), outputs_detached.cpu().numpy())
            ...
            if avg_valid_dice > best_acc:
                ...
                save_path = os.path.join(config["save_location"], "best_segmentation_model_seed_test_3D" + str(seed))
