...
def plot_3d_predictions():
    ...
    json_file_path = "/UserData/Zach_Analysis/uw_lymphoma_pet_3d/output_resampled_and_cropped_5.json"
    ...
    for label in prediction_list:
        ...
        axes[0].imshow(label_mip, alpha=norm(label_mip.T), aspect='auto', origin='lower')
        ...
        axes[1].imshow(prediction_mip, cmap="cool", alpha=norm(prediction_mip.T), aspect='auto', origin='lower')
        ...
        axes[2].imshow(label_mip, alpha=norm(label_mip.T), aspect='auto', origin='lower')
        axes[2].imshow(prediction_mip, cmap="cool", alpha=norm(prediction_mip.T), aspect='auto', origin='lower')
        ...
        # Save the figure
        #plt.tight_layout()
        plt.savefig("/UserData/Zach_Analysis/petlymph_image_data/prediction_mips_for_presentations/3d_predictions_v5_f1_.65/" + label_name + ".png")
        plt.close()
