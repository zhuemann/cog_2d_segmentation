...
def plot_mips_with_labels(df):
    ...
    label_path_base = "/UserData/Zach_Analysis/petlymph_image_data/labels_v13_nifti_test/" #v12 is .5 threshold v11 is .6 threshold v10 is ITM
    ...
    for index, row in df.iterrows():
        ...
        plt.savefig("/UserData/Zach_Analysis/petlymph_image_data/prediction_mips_for_presentations/mip_plot_itm_test_update/" + label_name)
        plt.close()
        #plt.show()