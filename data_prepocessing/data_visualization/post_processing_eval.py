...
def post_processing_eval():
    ...
    prediction_location = "/UserData/Zach_Analysis/git_multimodal/3DVision_Language_Segmentation_inference/COG_dynunet_baseline/COG_dynunet_0_baseline/dynunet_0_0/paper_predictions/.25_roberta_large_predictions_v3/"
    ...
    for label in prediction_list:
        ...
        print(f"max pixel: {np.max(prediction_data)}")
