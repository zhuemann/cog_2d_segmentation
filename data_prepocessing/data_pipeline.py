...
def run_data_pipeline_final():
    save_base = "/UserData/Zach_Analysis/suv_slice_text/uw_all_pet_preprocess_chain_v3/"
    save_base_final = "/UserData/Zach_Analysis/petlymph_image_data/"
    ...
    df.to_excel(save_base + "llm_remove_multipled_descriptions_test_5_250_test_v2.xlsx", index=False, sheet_name='Predictions')
