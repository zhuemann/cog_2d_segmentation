...
def create_mips(df):
    ...
    label_path_base = "/UserData/Zach_Analysis/petlymph_image_data/labels_v7_nifti/"
    ...
    for index, row in df.iterrows():
        ...
        label_name = row["Label_Name"]
        # print(img.shape)
        filename_img = "/UserData/Zach_Analysis/petlymph_image_data/images_coronal_mip_v8/" + str(petlymph) + ".png"
        filename_label = "/UserData/Zach_Analysis/petlymph_image_data/labels_coronal_mip_v8/" + str(label_name) + ".png"
