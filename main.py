...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 16, "dir_base": directory_base, "epochs": 1000, "n_classes": 2, "LR": 1e-3,
    ...
    for seed in seeds:
        ...
        folder_name = "/contextual_net_1000ep_threshold_labels_point_5_v24/seed" + str(seed) + "/"
