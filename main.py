...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 32, "dir_base": directory_base, "epochs": 250, "n_classes": 2, "LR": 1e-3,
    ...
    for seed in seeds:
        ...
        folder_name = "/contextual_net_1000ep_uw_dataset_larger_images_v4/seed" + str(seed) + "/"
