...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 20, "dir_base": directory_base, "epochs": 1000, "n_classes": 2, "LR": 1e-3,
    ...
    for seed in seeds:
        ...
        folder_name = "/contextual_net_higher_lr_2000ep_drop_multiple_slice_suv_v22/seed" + str(seed) + "/"
