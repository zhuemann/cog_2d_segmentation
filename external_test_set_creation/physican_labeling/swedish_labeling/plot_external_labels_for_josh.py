...
def get_slice_thickness(folder_name):
    ...
    image_path_base ="/mnt/Bradshaw/UW_PET_Data/physican_labels/final_external_dataset/images/"
...
def plot_final_testset_for_josh_v3_external():
    ...
    for index, row in df.iterrows():
        ...
        label_coronal_rescaled = label_coronal
        label_sagittal_rescaled = label_sagittal
        ...
        plt.savefig(
            "/UserData/Zach_Analysis/physican_labeling_UWPET/swedish_labeled_dataset/external_plots_for_josh/" + label_name + ".png",
            dpi=300)
