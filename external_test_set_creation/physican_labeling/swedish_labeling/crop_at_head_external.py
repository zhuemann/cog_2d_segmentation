...
def crop_at_head_calculation_external():

    #base_folder = "/mnt/Bradshaw/UW_PET_Data/SUV_images/"
    base_folder = "/UserData/Zach_Analysis/swedish_hospital_external_dataset/external_testset_v2/"
    ...
    save_base = "/UserData/Zach_Analysis/physican_labeling_UWPET/swedish_labeled_dataset/crop_at_head_plots/"
    ...
    df.to_excel('/UserData/Zach_Analysis/physican_labeling_UWPET/swedish_labeled_dataset/crop_offset_lookup_exteranl.xlsx', index=False)