...
def plot_final_internal_dataset():
    ...
    label_path_base = "/mnt/Bradshaw/UW_PET_Data/physican_labels/final_internal_dataset/labels/"
    ...
    original_df = pd.read_excel("/UserData/Zach_Analysis/final_testset_evaluation_vg/all_labels_jdw.xlsx")
    ...
    for index, row in df.iterrows():
        ...
        save_path = "/UserData/Zach_Analysis/physican_labeling_UWPET/final_internal_dataset_plots/" + label_name + ".png"
