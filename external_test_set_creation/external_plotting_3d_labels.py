...
def plot_external_testset():
    ...
    df = pd.read_excel("/UserData/Zach_Analysis/suv_slice_text/swedish_hospital_external_data_set/swedish_dataframe_max_pixels_v8_flipped.xlsx")
    ...
    for index, row in df.iterrows():
        ...
        plt.savefig(
            "/UserData/Zach_Analysis/final_testset_evaluation_vg/external_mips_v2/" + label_name + ".png",
            dpi=300)
